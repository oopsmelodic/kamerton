                ...
                <div id="main" class="container-fluid" style="background-color: #eee;">
                    <div class="container col-md-offset-1 col-sm-offset-1 col-lg-offset-1 col-md-10 col-sm-10 col-lg-10">
                        ...
                        <div  class="col-md-12 col-sm-12 col-lg-12 shadow-block" style="margin-bottom: 10px;">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <h4 class="brd" align="center">ПОЗИТИВ / НЕГАТИВ</h4>
                                <canvas  style="height:50%; width: 100%;" id="attitudeChart"></canvas>
                            </div>                              
                        </div>
                    ...
                    <script src="js/IDOLinfo.js" language='javascript'></script>
                </div>
                <!-- /.container-fluid -->
