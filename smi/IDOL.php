                    ...
                    <div class="container col-md-12 col-sm-12 col-lg-12">
                            ...
                            <div  class="col-md-12 col-sm-12 col-lg-12">
                                <div class="col-md-12 col-sm-12 col-lg-12 shadow-block" style="margin-right: 10px;">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5 col-md-offset-1" style="margin-bottom: 10px;">
                                            <button data-bb-handler="danger" type="button" class="btn btn-danger">Сбросить</button>
                                        </div>
                                    </div>
                                </div>                              
                            </div>
                        ...
                        <div  class="col-md-8 col-sm-8 col-lg-8">
                            <div class="col-md-12 col-sm-12 col-lg-12 shadow-block">
                                ...
                                <canvas  style="height:40%; width: 100%;" id="attitudeChart"></canvas>
                            </div> 
                            <div class="col-md-12 col-sm-12 col-lg-12 shadow-block" style="margin-bottom: 10px;">
                                <div class="brd" id="doctext">
                                    <h4 align="center">Количество документов</h4>

                                </div>
                                <canvas  style="height:40%; width: 100%;" id="docChart"></canvas>                         
                            </div>    
                        </div>
