...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Переташите файлы для загрузки</b></span>",
            abortStr: "Прервать",
            cancelStr: "Отмена",
            deletelStr: "Удалить",
            doneStr: "Готово",
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    ...
                    $('.ajax-upload-dragdrop i').click(function (){
                        $('.ajax-upload-dragdrop').find('input').click();
                    });
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='ajax-file-upload-statusbar animated fadeIn'></div>");
            this.filename = $("<div class='ajax-file-upload-filename'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='ajax-file-upload-bar progress-bar progress-bar-striped active" + obj.formGroup + "'></div>").appendTo(this.progressDiv);
            this.abort = $("<div class='ajax-file-upload-red btn btn-error " + obj.formGroup + "'>" + s.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = $("<div class='ajax-file-upload-red btn btn-error'>" + s.cancelStr + "</div>").appendTo(this.statusbar).hide();
            this.done = $("<div class='ajax-file-upload-green btn btn-success'>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
