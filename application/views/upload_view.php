...
<div id="qunit-fixture">
    ...
    <form id="fileupload" action="/php/file_upload/" method="POST" enctype="multipart/form-data">
...
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/vendor/jquery.ui.widget.js"></script>
<script src="//blueimp.github.io/JavaScript-Templates/js/tmpl.min.js"></script>
<script src="//blueimp.github.io/JavaScript-Load-Image/js/load-image.all.min.js"></script>
<script src="//blueimp.github.io/JavaScript-Canvas-to-Blob/js/canvas-to-blob.min.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.iframe-transport.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload.js"></script>
<script>
/* global window, $ */
window.testBasicWidget = $.blueimp.fileupload;
</script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload-process.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload-image.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload-audio.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload-video.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload-validate.js"></script>
<script src="/bower_components/jQuery-File-Upload-9.10.6/js/jquery.fileupload-ui.js"></script>
<script>
/* global window, $ */
...
$(function () {
    ...
    test('Data attribute options', function () {
        $('#fileupload').attr('data-url', '/php/file_upload/');
