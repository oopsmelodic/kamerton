...
<!--        <script src="/new/bower_components/typeahead.js/dist/bloodhound.js"></script>
    ...
    <script src="/bower_components/bootstrap-table-master/bootstrap-table-all.js"></script>
    ...
    <!--<script src="/bower_components/bootstrap-table-master/extensions/editable/bootstrap-table-editable.js"></script>-->
    <!--<script src="/bower_components/bootstrap-table-master/extensions/editable/bootstrap-table-editable.js"></script>-->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="disabled">
                            <a href="#"><i class="glyphicon glyphicon-user disabled"></i> Профиль</a>
                        </li>
                        <li class="disabled">
                        ...
                        <li class="">
                            <a href="/user/ftp"><i class="glyphicon glyphicon-transfer"></i> FTP</a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <li id="" >
                    <a href="/user/shedule"><i class="glyphicon glyphicon-calendar"></i>&nbsp&nbsp&nbsp Расписание</a>
                </li>
                <li id="files_upload" >
                    <a href=""><i class="glyphicon glyphicon-upload"></i>&nbsp&nbsp&nbsp Загрузить</a>
                </li>
<!--                <li id="files" >
