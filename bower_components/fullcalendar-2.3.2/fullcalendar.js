...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		var titleHtml;
                var repeat;
		if (event.repeat>0){
                    repeat ='<i class="glyphicon glyphicon-repeat"></i>&nbsp;';
                }else{
                    repeat = '';
                }
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content">' +
					(this.isRTL ?
						repeat+titleHtml + ' ' + timeHtml : // put a natural space in between
						repeat+timeHtml + ' ' + titleHtml   //
						) +
				'</div>' +
			...
			'>' +
				'<div class="fc-content">' +
					(timeText ? 
						...
						'>' +
							'<i class="glyphicon glyphicon-time"></i><span> ' + htmlEscape(timeText) + '</span>' +
						'</div>' :
						''
						) +
					(event.title ? 
						'<div class="fc-title">' +
                                                        repeat + htmlEscape(event.title) + 
						'</div>' :
						''
						) +
				'</div>' +
							...
							button = $( // type="button" so that it doesn't submit a form
								...
								.hover(
									...
									function() {
										...
										button
											.removeClass('hover')
											.removeClass('down'); // if mouseleave happens before mouseup
									}
								);
